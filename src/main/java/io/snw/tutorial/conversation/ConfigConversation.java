...
public class ConfigConversation {
    ...
    private class AutoUpdater extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "&8>Current Setting for Auto-Updater: " + String
                    .valueOf(Getters.getGetters().getConfigs().getUpdate())
    ...
    private class Metrics extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "&8>Current Setting for Metrics: " + String
                    .valueOf(Getters.getGetters().getConfigs().getMetrics())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class SignText extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "&8>Current Setting for Sign Text: " + String
                    .valueOf(Getters.getGetters().getConfigs().signSetting())
    ...
    private class FirstJoin extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "&8>Current Setting for First Join: " + String
                    .valueOf(Getters.getGetters().getConfigs().firstJoin())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class FirstJoinTutorial extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "&8>Current Setting for First Join Tutorial: " + String
                    .valueOf(Getters.getGetters().getConfigs().firstJoinTutorial())
    ...
    private class Rewards extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "&8>Current Setting for Rewards: " + String
                    .valueOf(Getters.getGetters().getConfigs().getRewards())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class ExpCountDown extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for Exp CountDown: " + String
                    .valueOf(Getters.getGetters().getConfigs().getExpCountdown())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class ViewMoney extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for View Money: " + String
                    .valueOf(Getters.getGetters().getConfigs().getPerViewMoney())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class ViewExp extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for View Exp: " + String
                    .valueOf(Getters.getGetters().getConfigs().getPerViewExp())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class TutorialMoney extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for Turtorial Money: " + String
                    .valueOf(Getters.getGetters().getConfigs().getPerTutorialMoney())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class TutorialExp extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for Tutorial Exp: " + String
                    .valueOf(Getters.getGetters().getConfigs().getPerTutorialExp())
                                                               + "\n&8>Valid inputs are True, False, Cancel(cancels changing the setting)");
        }
    ...
    private class PerTutorialMoney extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for Turtorial Money Reward: " + String
                    .valueOf(Getters.getGetters().getConfigs().getTutorialMoney())
    ...
    private class PerTutorialExp extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for Turtorial Exp Reward: " + String
                    .valueOf(Getters.getGetters().getConfigs().getTutorialExp())
    ...
    private class PerViewMoney extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for View Money Reward: " + String
                    .valueOf(Getters.getGetters().getConfigs().getViewMoney())
    ...
    private class PerViewExp extends StringPrompt {
        ...
        @Override
        public String getPromptText(ConversationContext context) {
            return ChatColor.translateAlternateColorCodes('&', "Current Setting for View Exp Reward: " + String
                    .valueOf(Getters.getGetters().getConfigs().getViewExp())
                                                               + "\n&8>Valid inputs is a Number with 1 decimal place(Ex: 1.1) or cancel(cancels changing the setting)");
        }
